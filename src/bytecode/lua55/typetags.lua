--- Lua 5.5 type tags for bytecode constants.
-- Defines the base type tags and their variant forms as used in the
-- Lua 5.5 bytecode constant pool. Each tag identifies the type of a
-- constant value stored in a compiled chunk.
-- @module llx.bytecode.lua55.typetags

local environment = require 'llx.environment'
local enum = require 'llx.bytecode.lua55.enum' . enum
...
--- Bidirectional enum of all Lua 5.5 type tags and their variants.
