...
-- low-level reader for Lua 5.5 bytecode files.
--
-- The varint encoding in Lua 5.5 uses the opposite convention from 5.4:
-- high bit 1 means more bytes follow, high bit 0 means last byte.
-- @module llx.bytecode.lua55.bytestream
...
local bytestream_metatable = {
  ...
  -- more bytes follow (1 = more bytes, 0 = last byte).
  -- This is the opposite convention from Lua 5.4.
  -- @return the decoded integer value
