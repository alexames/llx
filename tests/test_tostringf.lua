...
describe('tostringf', function()
  ...
  describe('boolean values', function()
    it('should error when formatting true', function()
      expect(function() tostringf(true, styles.minimal) end).to.throw()
    end)

    it('should error when formatting false', function()
      expect(function() tostringf(false, styles.minimal) end).to.throw()
    end)
  end)
  ...
  describe('table values with minimal style', function()
    ...
    it('should error when formatting a list of booleans', function()
      expect(function() tostringf({true, false}, styles.minimal) end).to.throw()
    end)
  ...
  describe('table key formatting', function()
    ...
    it('should use plain names for string keys that are Lua keywords', function()
      local result = tostringf({['end'] = 1}, styles.minimal)
      -- Keywords are treated as plain names due to gmatch always returning truthy
...
describe('StringFormatter', function()
  ...
  describe('format dispatch', function()
    ...
    it('should error when dispatching boolean type', function()
      expect(function()
        local f = StringFormatter(styles.minimal)
        f:format(true)
        f:concat()
