...
describe('Number', function()
  ...
  describe('__validate', function()
    ...
    describe('minimum (inclusive, value >= minimum)', function()
      it('should pass when value is greater than minimum', function()
        local ok = Number.__validate(10, { minimum = 5 }, {}, 0, nil)
        expect(ok).to.be_true()
      end)

      it('should pass when value equals minimum (inclusive)', function()
        local ok = Number.__validate(5, { minimum = 5 }, {}, 0, nil)
        expect(ok).to.be_true()
      end)
    ...
    describe('exclusive_minimum (value > exclusive_minimum)', function()
    ...
    describe('maximum (inclusive, value <= maximum)', function()
      it('should pass when value is less than maximum', function()
        local ok = Number.__validate(3, { maximum = 5 }, {}, 0, nil)
        expect(ok).to.be_true()
      end)

      it('should pass when value equals maximum (inclusive)', function()
        local ok = Number.__validate(5, { maximum = 5 }, {}, 0, nil)
        expect(ok).to.be_true()
      end)
    ...
    describe('exclusive_maximum (value < exclusive_maximum)', function()
