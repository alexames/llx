...
require 'llx.tests.test_functional_combinators2'
require 'llx.tests.test_functional_combinators3'
require 'llx.tests.test_functional_iterators'
require 'llx.tests.test_functional_iterators2'
require 'llx.tests.test_string_utils'
require 'llx.tests.test_string_utils2'
require 'llx.tests.test_string_utils3'
require 'llx.tests.test_table_utils'
require 'llx.tests.test_table_utils2'
require 'llx.tests.test_set_utils'
require 'llx.tests.test_set_utils2'
require 'llx.tests.test_getclass'
require 'llx.tests.test_hash'
require 'llx.tests.test_mathx'
require 'llx.tests.test_mathx2'
require 'llx.tests.test_mathx3'
...
require 'llx.tests.test_operators2'
